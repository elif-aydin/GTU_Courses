...
bool Memory::getMem(const string num, int &number) const
{
    int memoryAddress;
...
bool Memory::convertToNumber(int &total, const string & element) const
{
    int j, m, sign = 0;
    total = 0;
...
bool Memory::getTheAddress(int &number, string operand) const
{
