...
int CPU::jmpCommand(const string & operands, Memory & memory)
{
...
int CPU::jpnCommand(const string & operands, Memory & memory)
{
    string op1, op2;
    extractOperands(operands, op1, op2);
...
bool CPU::prnCommand(const string & operands, Memory & memory)
{
...
bool CPU::getTheAddress(int &number, string operand)
{
...
void CPU::convertToUppercase(string &line)
{
...
void CPU::removeSpaces(string &line)
{   
    int m;    
