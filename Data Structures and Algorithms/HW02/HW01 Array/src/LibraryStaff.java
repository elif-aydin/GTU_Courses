...
public final class LibraryStaff extends AbstractUser
{
    ...
    public boolean registerTest(String name, String surname, String id, String password, MyArray users)
    {
     ...
     */
    public boolean registerUser(MyArray users)
    {
        LibraryUser user= new LibraryUser();
        Scanner input = new Scanner(System.in);
     ...
     */
    private boolean checkUser(String ID, MyArray users)
    {
     ...
     */
    public boolean addBook(MyArray books)
    {
        Book book = new Book();
        Scanner input = new Scanner(System.in);
     ...
     */
    private boolean checkBookID(String ID, MyArray books)
    {
        for (int i = 0; i < books.size(); i++) //Book book : books)
        {
     ...
     */
    public boolean removeBook(MyArray books)
    {
        Scanner input = new Scanner(System.in);
     ...
     */
    private Book checkBookForRemove(String unknown, MyArray books)
    {
        for (int i = 0; i < books.size(); i++) //Book book : books)
        {
            Book book = (Book) books.get(i);
