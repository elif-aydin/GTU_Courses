...
public final class LibraryUser extends AbstractUser
{
     ...
     */
    public boolean barrow(MyArray books)
    {
        if (!(numOfBooks < 3))
        {
     ...
     */
    private Book searchBook(String bookName, MyArray books)
    {
     ...
     */
    public boolean returnBook(MyArray/*List<Book>*/ books)
    {
        if (!(numOfBooks > 0))
        {
    ...
    public void printOwnedBooks(MyArray books)
    {
