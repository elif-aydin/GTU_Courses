...
public final class LibraryStaff extends AbstractUser
{
    ...
    public boolean registerTest(String name, String surname, String id, String password, List<User> users)
    {
    ...
    public boolean addBookTest(String name, String author, String ID, List<Book> books)
    {
        Book book = new Book();
